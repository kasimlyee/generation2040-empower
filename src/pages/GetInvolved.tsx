...
import { Heart, Users, HandHeart, Gift, Building, UserCheck } from "lucide-react";

const GetInvolved = () => {
  const donationAmounts = [
    { amount: 50000, description: "Provides mental health support for 5 individuals" },
      ...
      <section className="gradient-warm py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto animate-slide-up">
            Join us in empowering communities and creating lasting positive change in Buikwe District.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-muted-foreground mb-8 leading-relaxed">
                Your donation directly impacts the lives of vulnerable individuals and families in Buikwe District. Every contribution, no matter the size, helps us expand our reach and improve our programs.
              </p>
              
              <div className="space-y-4 mb-8">
                {donationAmounts.map((donation, index) => (
                  <div key={index} className="flex items-center justify-between p-4 bg-background rounded-lg shadow-soft">
                    <div>
                      <span className="text-lg font-semibold text-primary">UGX {donation.amount.toLocaleString()}</span>
                      <p className="text-sm text-muted-foreground">{donation.description}</p>
                    </div>
                    <Button variant="cta" size="sm">Select</Button>
                  </div>
                ))}
              </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                {[
                  { amount: "UGX 25,000", impact: "Provides a month of nutritional support for one child" },
                  { amount: "UGX 75,000", impact: "Funds three counseling sessions for trauma survivors" },
                  { amount: "UGX 150,000", impact: "Supports one person through complete business training" },
                  { amount: "UGX 300,000", impact: "Establishes seeds and tools for a family garden" }
                ].map((item, index) => (
                  <div key={index} className="flex items-start space-x-4 p-4 bg-background rounded-lg shadow-soft">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-muted-foreground mb-8 leading-relaxed">
                Share your skills, experience, and passion with our community. Whether you can commit a few hours a week or a few days a month, your contribution makes a difference.
              </p>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <Select>
                      ...
                      <SelectContent>
                        <SelectItem value="counseling">Psycho-social Support</SelectItem>
                        <SelectItem value="business">Economic Empowerment</SelectItem>
                        <SelectItem value="agriculture">Food Security</SelectItem>
                  ...
                  <div>
                    ...
                    <Textarea id="availability" placeholder="When are you available to volunteer?" />
                  </div>
                  <Button variant="hero" className="w-full">
                    Submit Application
                  </Button>
