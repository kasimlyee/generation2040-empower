...
const Impact = () => {
  ...
  const stories = [
    {
      ...
      story:
        "After participating in our business training program, Sarah launched a successful tailoring business that now employs 5 other women in her community.",
    ...
    },
    {
      ...
      story:
        "Through our agricultural training, James transformed his family's subsistence farming into a profitable venture, improving nutrition and income.",
    ...
    },
    {
      ...
      story:
        "After receiving counseling support, Grace became a peer counselor helping other trauma survivors in her community rebuild their lives.",
  ...
  const reports = [
    ...
    },
    {
      ...
      description:
        "Independent evaluation of our psycho-social empowerment programs",
      pages: 24,
      year: "2023",
      downloadUrl: "#",
    },
    {
      ...
      description:
        "Detailed breakdown of funding sources and expenditure allocation",
      pages: 16,
      year: "2023",
      downloadUrl: "#",
    },
      ...
      <section className="gradient-warm py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto animate-slide-up">
            Measuring the positive change we're creating in Buikwe District
            communities through data-driven insights and real stories.
          </p>
        </div>
      </section>
            ...
            {keyMetrics.map((metric, index) => (
              ...
              >
                <CardContent className="p-6">
                  <div
                    className={`w-16 h-16 mx-auto mb-4 gradient-primary rounded-full flex items-center justify-center text-white`}
                  >
                    {metric.icon}
                  </div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Join us in creating positive change and help us reach even more
            communities in need.
          </p>
