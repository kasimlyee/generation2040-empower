  ...
  const photos = [
    {
      ...
      description:
        "Farmers learning sustainable agriculture techniques in our food security program.",
    },
    {
      id: 2,
      ...
      description:
        "Community members participating in group therapy and support sessions.",
    },
    {
      id: 3,
      ...
      description:
        "Our successful 2023 fundraising event with community leaders and supporters.",
    },
    {
      id: 4,
      ...
      description:
        "Young leaders from across Buikwe District gathered for skills development.",
    },
    {
      id: 5,
      ...
      description:
        "Women entrepreneurs showcase their businesses and share success stories.",
    },
    {
      id: 6,
      ...
      description:
        "Our team engaging with community members during outreach programs.",
    },
    {
      id: 7,
      ...
      description:
        "Entrepreneurs receiving business development and financial literacy training.",
    },
    {
      id: 8,
      ...
      description:
        "Generation 2040 staff and volunteers during our annual team retreat.",
    },
    {
      id: 9,
      ...
      description:
        "Grand opening ceremony of our new community wellness center.",
    },
    {
      id: 10,
      ...
      description:
        "Children participating in educational and recreational activities.",
    },
    {
      id: 11,
      ...
      description:
        "Our demonstration agricultural site showcasing sustainable farming techniques.",
    },
    {
      id: 12,
      ...
      description:
        "Strategic planning meeting with local government and partner organizations.",
    },
  ];
  ...
  const videos = [
    {
      ...
      duration: "3:45",
      description:
        "Documentary showcasing the transformation in Buikwe District communities.",
    },
    {
      id: 2,
      ...
      duration: "5:20",
      description:
        "Beneficiaries share their stories of empowerment and growth.",
    },
    {
      id: 3,
      ...
      duration: "7:15",
      description:
        "Comprehensive guide to our agricultural empowerment programs.",
    },
  ];
      ...
      <section className="gradient-warm py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto animate-slide-up">
            Explore visual stories of transformation, community engagement, and
            positive impact across Buikwe District.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {photos.map((photo) => (
              <Card
                key={photo.id}
                className="overflow-hidden shadow-soft hover:shadow-medium transition-smooth group cursor-pointer"
              >
