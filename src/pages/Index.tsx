...
import psychosocialImage from "../assets/images/cow.jpg";
import economicImage from "../assets/images/meeting2.jpg";
import foodSecurityImage from "../assets/images/food.jpg";
...
const Index = () => {
  ...
  const programs = [
    {
      title: "Farming Empowerment",
      description: "Supporting community through farming",
      image: psychosocialImage,
      icon: <Brain className="w-6 h-6" />,
      beneficiaries: "1,200+",
      highlights: ["Farming tips", "Community teaching"],
    },
    {
      title: "Economic Empowerment",
      description:
        "Skills training, microfinance support, and business development programs that create sustainable livelihoods and economic independence.",
      image: economicImage,
    ...
    },
    {
      ...
      description:
        "Agricultural training, community gardens, and nutrition programs that address food insecurity and promote sustainable farming practices.",
  ...
  const testimonials = [
    {
      ...
      role: "Business Owner",
      content:
        "Thanks to Generation 2040's business training program, I was able to start my tailoring business. Now I employ 5 women in my community and support my family comfortably.",
      avatar:
    ...
    },
    {
      ...
      role: "Farmer",
      content:
        "The agricultural training transformed my farm. My crop yields increased by 300%, and I can now feed my family year-round while selling surplus to the market.",
      avatar:
    ...
    },
    {
      ...
      content:
        "After receiving psycho-social support, I became empowered to help others. I now serve as a peer counselor, supporting 20+ community members through their healing journeys.",
      avatar:
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {partners.map((partner, index) => (
              <Card
                key={index}
                className="p-6 text-center shadow-soft hover:shadow-medium transition-smooth"
              >
          ...
          <Card className="gradient-hero text-white shadow-strong">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-xl mb-8 opacity-90">
                Your support can transform lives and empower entire communities.
                Together, we can build a better future for Buikwe District.
              </p>
              ...
              <div className="mt-8 pt-8 border-t border-white/20">
                <p className="text-center opacity-90">
                  <strong>We Are Just A Call Away!</strong> Call us now for
