      ...
      <section className="gradient-warm py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto animate-slide-up">
            We're here to help. Reach out to us for consultancy services, partnerships, or any questions about our work.
          </p>
        </div>
      </section>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-8">
                  We're always ready to help and answer any questions you might have. Whether you're interested in our programs, looking for partnership opportunities, or need consultancy services, don't hesitate to reach out.
                </p>
              </div>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">Buikwe District, Uganda</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
              ...
              <Card className="bg-gradient-to-r from-primary to-secondary text-white shadow-medium">
                <CardContent className="p-6 text-center">
                  <h3 className="text-xl font-bold mb-2">We Are Just A Call Away!</h3>
                  <p className="mb-4 opacity-90">
                    Call us now for consultancy services and partnership opportunities.
                  </p>
          ...
          <Card className="shadow-medium overflow-hidden">
            <div className="h-96 bg-muted flex items-center justify-center">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-2">Buikwe District, Uganda</h3>
                <p className="text-muted-foreground">
                  Interactive map will be integrated here showing our exact location and service areas.
                </p>
              </div>
            </div>
          </Card>
